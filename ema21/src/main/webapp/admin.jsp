	...
	<script type="text/javascript">
        window.onload=function(){
            ...
            changeUser = function(operate , flag){
                switch (operate) {
                    case "remove":window.location="${pageContext.request.contextPath}/Yun/delete.do?username="+username+"";break;
                    case "changeStatu":window.location="${pageContext.request.contextPath}/Yun/updateStatus.do?username="+username+"&status="+status+"";break;
        ...
        function  test(){
            var  count=$("#c").val();
            location.href="${pageContext.request.contextPath}/Yun/FindAllUserByPage.do?count="+count;
        }

        function selectUser(username){

            $.ajax({
                url:"${pageContext.request.contextPath}/Yun/selectByName.do",
                type:"GET",
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
												data-toggle="dropdown" role="button" aria-expanded="false">管理员[${sessionScope.admin.name}]
							<span class="caret"></span>
						</a>
							<ul class="dropdown-menu" role="menu">
								<li><a href="#">个人资料</a></li>
								<li class="divider"></li>
								<li><a href="${pageContext.request.contextPath}/Yun/ExitServlet.do">退出</a></li>
							</ul></li>
					</ul>
				</div>
				<!-- /.navbar-collapse -->
			...
			<div class="table-responsive">
				<div class="row">
					...
					<div class="col-md-3 form-group ">
						<form class="form-inline" action="${pageContext.request.contextPath}/Yun/FindOneServlet.do" method="post" id="form1">
				...
				<div class="form-group col-md-12 collapse" id="addUserForm">
					<div class="well">
						<form action="${pageContext.request.contextPath}/Yun/AddUser.do" method="post">
							<table  class="table-condensed">
								...
								<tr>
									...
									<td><select required="required" class="form-control" name="source">
				...
				<div class="form-group col-md-12 collapse" id="updateUserForm">
					<div class="well">
						...
						<table class="table-condensed " style="text-align: center;">
							...
							<form id="ff"   class="" action="${pageContext.request.contextPath}/Yun/updateUser.do" method="post" >
								<tbody>
								<tr id="updateTr">
				...
				<table  style="text-align:center" id="userPager"
					...
					<c:forEach items="${requestScope.list}" var="user">
						<tr class="bg-danger" >
							...
							<td>${user.ip}</td>
							<td>
								<a type="button" data-toggle="modal"data-target="#freezUser" class="btn btn-danger btn-sm" onclick="changeUser('${user.username}', '${user.status}')">${user.status}</a>
							</td>
							<td>
				...
				<div align="center">
					<div class="pagination">
						<ul>
							...
							<li><a href="#">条</a></li>
							<li><a href="#">共${requestScope.page}页</a></li>
							<li>
								<a href="${pageContext.request.contextPath}/Yun/FindAllUserByPage.do?x=-1"> 上一页</a>
								<a href="${pageContext.request.contextPath}/Yun/FindAllUserByPage.do?x=1"> 下一页</a>
							</li>
						</ul>
					</div>
				</div>
