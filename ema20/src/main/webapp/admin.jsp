	...
	<script type="text/javascript">
        window.onload=function(){
            ...
            changeUser = function(operate , flag){
                switch (operate) {
                    case "remove":window.location="删除的URL？username";break;
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
												data-toggle="dropdown" role="button" aria-expanded="false">管理员[小白]
			...
			<div class="table-responsive">
				<div class="row">
					...
					<div class="col-md-3 form-group ">
						<form class="form-inline" action="${pageContext.request.contextPath}/user/FindOneServlet" method="post" id="form1">
				...
				<div class="form-group col-md-12 collapse" id="addUserForm">
					<div class="well">
						<form action="${pageContext.request.contextPath}/user/AddUserServlet" method="post">
				...
				<div class="form-group col-md-12 collapse" id="updateUserForm">
					<div class="well">
						...
						<table class="table-condensed " style="text-align: center;">
							...
							<form id="ff"   class="" action="/Aut/user/updateUserServlet" method="post" >
								<tbody>
								<tr id="updateTr">
				...
				<table  style="text-align:center" id="userPager"
					...
					<tr class="bg-danger" >
						...
						<td>127.0.0.1</td>
						<td>
							<a type="button" data-toggle="modal"data-target="#freezUser" class="btn btn-success btn-sm" onclick="changeUser('${user.username}', 'Yes')">激活</a>
						</td>
						<td>
							<div class="btn-group" role="group">
								<button class="btn btn-default btn-sm" data-toggle="modal"
