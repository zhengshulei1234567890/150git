		...
		<table bordercolor='#898E90' align='center' border='3px' cellpadding='10px' cellspacing="0px" >
			...
			<c:forEach items="${list}" var="category">
				<tr>
					...
					<td>
						<div class="button" onclick="location.href='${pageContext.request.contextPath }/category/deleteCategoryById?category.id=${category.id}&category.levels=${category.levels}' ">删除 &raquo;</div>	
					</td>
				</tr>
			</c:forEach>
		</table><br/>
